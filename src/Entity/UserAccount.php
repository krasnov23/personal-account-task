...
class UserAccount
{
    ...
    #[ORM\OneToMany(mappedBy: 'userAccount', targetEntity: Transaction::class, orphanRemoval: true)]
    private Collection $userTransactions;

    #[ORM\ManyToMany(targetEntity: ServiceInfo::class, inversedBy: 'userAccounts')]
